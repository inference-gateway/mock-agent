...
>   to see the spans — see [`examples/opentelemetry`](examples/opentelemetry).
...
| **Simulation** | `MOCK_TOOL_CALLS` | (unset) |
| **Simulation** | `MOCK_TOOL_CALL_DURATION_MS` | `100` |

See [Simulating multi-tool-call workloads](#simulating-multi-tool-call-workloads)
for what these do.
