...
The codebase is generated using ADL CLI 0.23.10 and follows a strict generation pattern:
...
# Build
task build        # Creates bin/mock-agent
...
- **ADL Version**: Ensure ADL CLI 0.23.10 or compatible version for regeneration
